...
export default function CohortStats({ cohort, entries = [], currentUserEmail, loading, error }) {
  ...
  // The cohort's program-specific badge ladder. GamificationStrip and
  // CohortLeaderboard both consume this so APFW gets APFW's milestones
...
function SummaryView({ metrics, participantCounts, innovations, entries, badges }) {
  return (
    <>
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
      ...
      <GamificationStrip entries={entries} badges={badges} />
