...
// cohort in their organization. Mirror of /facilitator/journal, scoped to
// the org's assignedOrgs.
// ---------------------------------------------------------------------------
      ...
      <main className="max-w-[1180px] mx-auto px-6 lg:px-8 py-8 lg:py-12 space-y-8">
        <header className="space-y-1.5 animate-fade-in-up">
          ...
          <p className="text-[14.5px] text-ink-muted mt-2 max-w-2xl leading-relaxed">
            Hours saved, wins shipped, and where the leverage is concentrating
                    ...
                    {cohorts.map((c) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-2.5 pr-4 text-[12px] text-ink-muted">
                            {c.facilitator?.name || "—"}
                          </td>
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[11.5px] text-ink-muted mt-0.5 inline-flex items-center gap-2 flex-wrap">
                      ...
                      {cohort && (
                        <span className="opacity-70">· {cohort.name}</span>
                      )}
                    </div>
                  </div>
